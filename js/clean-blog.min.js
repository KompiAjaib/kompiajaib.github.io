...
function makeShort(){var t=document.getElementById("longurl").value,e=gapi.client.urlshortener.url.insert({resource:{longUrl:t}});e.execute(function(t){null!=t.id?(str="",str+="<div class='output' contenteditable='true' onClick='document.execCommand(&quot;selectAll&quot;,false,null)'>"+t.id+"</div>",document.getElementById("output").innerHTML=str):alert("ERROR: creating short url \n"+t.error)})}function load(){gapi.client.setApiKey("AIzaSyD5dvNJ6BgfiO7bL-KQMX3OAgU1mfQLYBQ"),gapi.client.load("urlshortener","v1",function(){document.getElementById("output").innerHTML=makeShort()});for(var t=document.getElementsByTagName("iframe"),e=0;e<t.length;e++)t[e].getAttribute("data-src")&&t[e].setAttribute("src",t[e].getAttribute("data-src"));for(var r=document.getElementsByTagName("img"),e=0;e<r.length;e++)r[e].getAttribute("data-src")&&r[e].setAttribute("src",r[e].getAttribute("data-src"));setTimeout(function(){var e=document.querySelector("ins.adsbygoogle");e&&0==e.innerHTML.replace(/\s/g,"").length&&(e.style.cssText="display:block !important; visibility:visible !important;background:#e1e1e1!important;padding:6px 10px;position:relative!important;text-decoration:none !important;width:100%!important;min-height:90px!important;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box;font-family: inherit;font-size: 1.25em;color: #e00;",e.innerHTML="You seem to have an Adblock running. Ads are not cool but they keep my website runnning. I would really appreciate if you could whitelist my website in Adblock or buy me a cup of coffee!")},800)}!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://apis.google.com/js/client.js";var e=document.getElementsByTagName("script")[0];e.parentNode.insertBefore(t,e)}(),window.onload=load;
