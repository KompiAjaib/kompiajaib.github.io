...
function init(){for(var t=document.getElementsByTagName("iframe"),e=0;e<t.length;e++)t[e].getAttribute("data-src")&&t[e].setAttribute("src",t[e].getAttribute("data-src"));for(var r=document.getElementsByTagName("img"),e=0;e<r.length;e++)r[e].getAttribute("data-src")&&r[e].setAttribute("src",r[e].getAttribute("data-src"))}window.onload=init;
function makeShort(){var e=document.getElementById("longurl").value,t=gapi.client.urlshortener.url.insert({resource:{longUrl:e}});t.execute(function(e){null!=e.id?(str="",str+="<div class='output' contenteditable='true' onClick='document.execCommand(&quot;selectAll&quot;,false,null)' data-toggle='tooltip' data-placement='right' title='Click and CTRL+C'>"+e.id+"</div>",document.getElementById("output").innerHTML=str):alert("ERROR: creating short url \n"+e.error)})}function load(){gapi.client.setApiKey("AIzaSyD5dvNJ6BgfiO7bL-KQMX3OAgU1mfQLYBQ"),gapi.client.load("urlshortener","v1",function(){document.getElementById("output").innerHTML=makeShort()})}!function(){var e=document.createElement("script");e.type="text/javascript",e.async=!0,e.src="https://apis.google.com/js/client.js";var t=document.getElementsByTagName("script")[0];t.parentNode.insertBefore(e,t)}(),window.onload=load;
